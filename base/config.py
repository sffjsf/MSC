...
def base_config(cfg_dict):
    ...
    parser.add_argument('--vals', default='ECSSD', help='Set the testing sets') # SOD,PASCAL-S,ECSSD,DUTS-TE,HKU-IS,DUT-OMRON,MSB-TR
    parser.add_argument('--data_path', default='/home/zzx/USOD/A2S-USOD-main/dataset', help='The name of network')
    ...
    # testing
    parser.add_argument('--weight', default='/home/zzx/USOD/A2S-USOD-main/weight/cornet/resnet/base/cornet_base_25.pth', help='Trained weight path')
...
def cfg_convert(config):
    if config['vals'] == 'all':
        ...
        config['vals'] = ['ECSSD', 'DUT-OMRON','PASCAL-S','DUTS-TE','HKU-IS']
    else:
